...
<div id="contents">			
		<div class="highlight">
                        <div class="clearfix">
                            <?php echo form_open("anketa/adminRezultati/update", array('class' => 'message')); ?>
                            <table>  
                                <tr>
                                ...
                                <tr>
                                    <td><?php echo form_label("Rezultat:", "lRezultat"); ?></td>                                                                                                     
                                </tr>
                                <tr>                                        
                                    <td><?php echo form_input('tbRezultat'); ?></td>                                          
                                </tr>
                                <tr>
                            ...
                            <?php 
                                ...
                                if(isset($status))
                                {
                                    redirect(base_url()."anketa/adminRezultati/update");                                   
                                }
