...
<div id="contents">			
    <div class="highlight">
        <div class="clearfix">     
            <?php echo form_open("admin/upravljanje_rezervacijama/insert", array('class' => 'message')); ?>
            <table>
                <tr>
                ...
                <tr>                   
                    <td style="padding-bottom: 15px;"><?php echo form_dropdown("ddlPredstava", $predstaveItem); ?></td>
                </tr>
                <tr>
            ...
            <table width ="100%" border = "1" >   
                ...
                <?php 
                    ...
                    if(isset($status))
                    {
                        redirect(base_url()."admin/upravljanje_rezervacijama/insert");                                   
                    }
                ?>
            </table>                          
        </div>
