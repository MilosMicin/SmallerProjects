<?php
	...
	if(isset($_POST['btnRegistracija']))
	{
		...
		$upit = "SELECT * FROM admin WHERE admin_user = '".$username."' AND admin_pass = '".$password."'";
...
<div id="wrapper">
    ...
    <div id="main">
    	...
    	<div id="right-part">
        	<p><h2>Admin LOG</h2></p>
			<p>Morate se ulogovati kao administrator da bi mogli da nastavite dalje.</p>
			<form name = "registracija" method = "POST" action = "admin.php">
